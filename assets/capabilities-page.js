...
(function () {
  ...
  var DESC = {
    'Slitting': 'Precision slitting of master rolls into narrow widths to tight tolerances, in-house. Consistent edge quality and dimensional control across high volumes.',
    'Rewinding': 'Custom rewinding to specified roll lengths, core sizes and put-ups — matched to your application and dispensing equipment.',
    'Die Cutting': 'Rotary and flatbed die-cutting of tapes into application-ready parts, gaskets and shapes, supplied to the exact geometry each line requires.',
    'Lamination': 'Multi-layer lamination of films, foams, foils and adhesives into custom constructions engineered for the application.',
    'Sheet Conversion': 'Conversion of tapes into sheets, pads and kiss-cut parts for fast, accurate manual assembly.',
    'Custom Packaging': 'Private-label and custom packaging, kitting and labelling for OEM supply and distribution.',
    'OEM Programs': 'Dedicated OEM programs with qualification support, vendor-managed inventory and long-term supply agreements.'
  };
  ...
  function render(){
    ...
    out+='<div class="hero"><div class="hero-media lazy-loading-placeholder"><img class="fade-in-loaded" src="https://placehold.co/1600x600/2f3f5f/8ea0c8?text=" alt="DEON manufacturing capabilities" /></div>'+
      '<div class="hero-card"><h1>Manufacturing &amp; converting capabilities</h1><p>DEON is a manufacturer and converter — not only a tape supplier. Our in-house slitting, die-cutting, lamination and conversion turn base tapes into application-ready parts, backed by dedicated OEM programs.</p></div></div>';
