...
(function () {
  ...
  // ---------- HEADER ----------
  function headerHTML(){
    var links = ARCH.level1.map(function(it){ return '<li><a href="'+esc(it.href)+'">'+esc(it.label)+'</a></li>'; }).join('');
    return '' +
  ...
  function footerHTML(){
    ...
    '<footer><div class="footer-scroll-top"><button class="scroll-top-btn" aria-label="Back to top" onclick="window.scrollTo({top:0,behavior:\'smooth\'})">&#8743;</button></div>' +
      '<div class="footer-top">' +
        ...
        '<div class="footer-col"><h4>Explore</h4><ul><li><a href="applications.html">Applications</a></li><li><a href="products.html">Products</a></li><li><a href="capabilities.html">Capabilities</a></li><li><a href="knowledge-center.html">Knowledge Center</a></li><li><a href="press.html">Press &amp; Insights</a></li><li><a href="contact.html">Contact</a></li></ul></div>' +
  ...
  function sidebarHTML(){
    ...
    panels.push(panel('markets', 'Markets', 'market.html',
      '<li><a href="market.html"><span>All markets</span></a></li>' +
    ...
    ARCH.markets.forEach(function(m){
      ...
      var items = '<li><a href="'+esc(href)+'"><span>Overview</span></a></li>' +
        m.segments.map(function(s){ return subLink(s.name, D.url.segment(s.id)); }).join('');
    ...
    panels.push(panel('applications', 'Applications', 'applications.html',
      '<li><a href="applications.html"><span>All applications</span></a></li>' +
      ARCH.applications.map(function(a){ return subLink(a.name, D.url.application(a.id)); }).join(''), 'Back to menu'));
    // products
    panels.push(panel('products', 'Products', 'products.html',
      '<li><a href="products.html"><span>All products</span></a></li>' +
      ARCH.productFamilies.map(function(f){ return subLink(f.name, D.url.productFamily(f.slug)); }).join(''), 'Back to menu'));
    // knowledge center
    panels.push(panel('knowledge', 'Knowledge Center', 'knowledge-center.html',
  ...
  function wire(){
    ...
    function setPanelsInstant(name){ navPanels.classList.add('no-anim'); panelStack=(name&&name!=='main')?['main',name]:['main']; renderPanels(true); void navPanels.offsetWidth; navPanels.classList.remove('no-anim'); }
