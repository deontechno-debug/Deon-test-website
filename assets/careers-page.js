...
(function () {
  ...
  // ~6 placeholder open roles. [Placeholder listings — apply via contact.]
  var ROLES = [
  ...
  function render(){
    ...
    out += '<div class="hero"><div class="hero-media lazy-loading-placeholder"><img class="fade-in-loaded" src="https://placehold.co/1600x600/3a4a6a/8ea0c8?text=" alt="Careers at DEON" /></div>'+
      ...
      '<p>DEON manufactures and converts adhesive tapes for industry — and we are always looking for engineers, chemists, operators and commercial talent who want to make precision products at scale. [Placeholder copy.]</p></div></div>';
    ...
    out += sect('why-deon', '', '<div class="feature-layout"><div>'+
      ...
      '<div class="market-intro"><p>We pair the stability of an established manufacturer with the pace of a growing one. You will work on real production lines and real customer problems, with the training and progression to grow with us. [Placeholder copy.]</p></div></div>'+
    ...
    out += sect('open-positions', 'is-grey', '<div class="market-eyebrow">Open positions</div><h2>Open positions</h2>'+
      '<div class="market-intro"><p>Current openings across manufacturing, R&amp;D, quality and commercial teams. Apply through our contact form and a member of the people team will be in touch. [Placeholder listings.]</p></div>'+
    ...
    out += sect('life-at-deon', '', '<div class="feature-layout"><div>'+
      ...
      '<div class="market-intro"><p>Our plants run on teamwork, safety and craft. People stay because the work is tangible, the teams are tight, and there is always a next problem worth solving. [Placeholder copy.]</p></div></div>'+
    ...
    out += '<div class="cta-strip"><div class="cta-img lazy-loading-placeholder"><img class="fade-in-loaded" src="https://placehold.co/800x600/3a4a6a/8ea0c8?text=" alt="Apply to DEON" /></div>'+
      ...
      '<p>Send us your details and the role you are interested in. We review every application and reach out to candidates whose experience fits our open positions. [Placeholder copy.]</p>'+
